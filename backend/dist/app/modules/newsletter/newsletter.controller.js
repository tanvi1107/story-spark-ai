...
exports.unsubscribe = exports.verify = exports.subscribe = void 0;
...
const subscribe = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield newsletterService.subscribeNewsletter(email, name, source, userId);
...
const unsubscribe = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield newsletterService.unsubscribeNewsletter(email);
        res.status(200).json(result);
    }
    catch (err) {
        res.status(400).json({
